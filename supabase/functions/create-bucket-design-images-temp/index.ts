...
Deno.serve(async (req) => {
    ...
    const policyQueries = [
        ...
        `CREATE POLICY "Public Access for design-images" ON storage.objects FOR SELECT USING (bucket_id = 'design-images');`,
        // Allow public to insert objects in this bucket
        `CREATE POLICY "Public Upload for design-images" ON storage.objects FOR INSERT WITH CHECK (bucket_id = 'design-images');`,
        // Allow public to update objects in this bucket
        `CREATE POLICY "Public Update for design-images" ON storage.objects FOR UPDATE USING (bucket_id = 'design-images');`,
        // Allow public to delete objects in this bucket
        `CREATE POLICY "Public Delete for design-images" ON storage.objects FOR DELETE USING (bucket_id = 'design-images');`
    ];
