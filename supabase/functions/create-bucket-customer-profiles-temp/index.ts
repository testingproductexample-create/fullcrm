...
Deno.serve(async (req) => {
    ...
    const policyQueries = [
        ...
        `CREATE POLICY "Public Access for customer-profiles" ON storage.objects FOR SELECT USING (bucket_id = 'customer-profiles');`,
        // Allow public to insert objects in this bucket
        `CREATE POLICY "Public Upload for customer-profiles" ON storage.objects FOR INSERT WITH CHECK (bucket_id = 'customer-profiles');`,
        // Allow public to update objects in this bucket
        `CREATE POLICY "Public Update for customer-profiles" ON storage.objects FOR UPDATE USING (bucket_id = 'customer-profiles');`,
        // Allow public to delete objects in this bucket
        `CREATE POLICY "Public Delete for customer-profiles" ON storage.objects FOR DELETE USING (bucket_id = 'customer-profiles');`
    ];
