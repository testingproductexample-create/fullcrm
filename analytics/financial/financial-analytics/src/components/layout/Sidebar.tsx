...
const navigation: NavigationItem[] = [
  ...
  { name: 'ROI Analysis', href: '/roi', icon: CalculatorIcon },
  { name: 'Budget Analysis', href: '/budget-analysis', icon: DocumentChartBarIcon },
  { name: 'VAT Compliance', href: '/vat-compliance', icon: ShieldCheckIcon },
  { name: 'Forecasting', href: '/forecasting', icon: ChartLineIcon },
